...
rollout: rollout-s1 rollout-s2 rollout-s3 rollout-db rollout-loader
...
cri: $(LOG_DIR)/s1.repo.log $(LOG_DIR)/s2-$(S2_VER).repo.log $(LOG_DIR)/s3.repo.log $(LOG_DIR)/db.repo.log $(LOG_DIR)/loader.repo.log
